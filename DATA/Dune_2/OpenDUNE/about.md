Проект по переносу игры в Windows. Готов далеко не полностью - например, глючит и плюётся ошибками при нажатии на некоторые горячие клавиши Для установки требуется игра версии 1.07, не ниже!
